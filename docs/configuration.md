...
flashapi.soft-delete.attribute-name=deletedAt
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `flashapi.soft-delete.attribute-name` | String | `deletedAt` | Java field name used for soft delete timestamps (maps to `deleted_at` column in DB) |
